const basicGameLaura = {
  ...
  createPlayer() {
    this.player = new Playerlaura(this.ctx, 200, 200, 120, 120, -0.5)
  },
  ...
  createObstacles() {
    ...
    this.obstaclesBottom.push(new ObstaclesBottomlaura(this.ctx, 1300, this.randomPos[0], 100, 800, 3));
    this.obstaclesTop.push(new ObstaclesTopLaura(this.ctx, 1300, (this.randomPos[0])-1000, 100, 800, 3))
  },
  ...
  createBackground() {
    this.backgroundImages.push(new BackgroundLaura(this.ctx, 0, 0, 2298, 600, 1));
  },
