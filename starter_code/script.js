...
class Board{
  constructor(){
      ...
      this.music.src = "http://66.90.93.122/ost/mario-and-luigi-dream-team/kobgupjs/04%20-%20Panic%20Pit.mp3"
  }
draw(){
...
function checkCollitions(){
  pipes.forEach(function(pipe){
    if(    flappy.crashWith(pipe))return gameOver()
  })
}
