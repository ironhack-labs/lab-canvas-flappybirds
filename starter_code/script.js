/***********************************
 * Set up Game (canvas) Environment
 ***********************************/
...
// Background Image
var bgImg = new Background(canvas.width);
// Faby Bird
var bird = new Bird(canvas.height);
...
function createObstacle() {
  var randomPos = Math.floor((Math.random() * canvas.height) / 2);
  var obstacle = new Obstacle(canvas.width, canvas.height, randomPos);
