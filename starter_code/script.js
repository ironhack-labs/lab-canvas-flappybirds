...
function start(){
    ...
    audioBack= new Audio("http://freesound.org/data/previews/274/274461_5232403-lq.mp3")
    audioBack.play()
}
function update(){
    frames++
...
function gameOver(){
    ...
    var audio = new Audio(src = "http://freesound.org/data/previews/382/382310_5421751-lq.mp3")
    audio.play()
}
