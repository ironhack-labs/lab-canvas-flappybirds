...
class Board {
  constructor() {
    ...
    this.img = new Image()
    this.img.src = '/home/cristopher/GIT/lab-canvas-flappybirds/starter_code/images/space'
    this.img.onload = () => {
      this.draw()
    }
  }
...
class IronMan {
  constructor(x, y) {
    ...
    this.height = 50
    this.img = new Image()
    this.img.src = '/home/cristopher/GIT/lab-canvas-flappybirds/starter_code/images/ironman'
  }
  draw() {
    this.y++
    ctx.drawImage(this.img, this.x, this.y, this.width, this.height)
...
const flappy = new IronMan(20, 10)
