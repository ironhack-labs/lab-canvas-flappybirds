...
class Board {
  constructor() {
    ...
    this.img = new Image()
    this.img.src = 'https://i.ytimg.com/vi/kSjsM9h9QbQ/maxresdefault.jpg'
    this.img.onload = () => {
      this.draw()
    }
  }
...
class Flappyoso {
  constructor(x, y) {
    ...
    this.height = 50
    this.img = new Image()
    this.img.src = 'https://toppng.com/public/uploads/preview/bad-bunny-sin-fondo-11549782819regxj5cpxc.png'
  }
  draw() {
    this.y++
    ctx.drawImage(this.img, this.x, this.y, this.width, this.height)
...
function gameOver() {
  ...
  ctx.fillStyle = 'white'
  ctx.fillText('G4m3 0v3r', canvas.width / 2 - 100, 100)
