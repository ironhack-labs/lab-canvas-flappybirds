...
var images = {
    ...
    soundStart: "Official Opening Credits Game of Thrones (HBO).mp3",
    soundOver: "Gameover Sound Effect.mp3"
}
...
var overSound = new GameOverSound()
//main functions
function start(){
    pipes = []
    frames = 0
...
function Sound(){
  ...
  this.sound.src = images.soundStart
  this.play = function(){
    this.sound.play()
  }
  this.stop = function(){
...
function GameOverSound(){
  Sound.call(this)
  this.sound.src = images.soundOver
